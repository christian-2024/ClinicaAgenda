...
namespace ClinAgenda.src.Infrastructure.Repositories
{
    public class AppointmentRepository : IAppointmentRepository
    {
        ...
        public async Task<(int total, IEnumerable<AppointmentListDTO> appointment)> GetAppointmentAsync(string? patientName, string? doctorName, int? specialtyId, int itemsPerPage, int page)
        {
